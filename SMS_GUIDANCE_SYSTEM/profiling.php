...
<div class="d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-secondary ms-1" role="button" href="#">Import</a> 
</div>   
...
$query="SELECT * FROM profiling LIMIT 0,5";
if($stmt=$conn->query($query)){
     
echo "<table class='table table-striped table-bordered border-dark'> 
<tr class='info'><th>ID</th><th>Name</th><th>Course</th><th>Year & Section</th><th>Status</th><th>Action</th></tr>";
while ($row=$stmt->fetch_array()) {
echo "<tr><td>$row[stud_id]</td><td>$row[fname]$row[lname]</td>
<td>$row[course]</td><td>$row[year_section]</td><td>$row[status]</td><td><a class='btn btn-primary' type='button' href=pages/profiling/viewStudent.php?stud_id=$row[stud_id]>View</a></td></tr>";
