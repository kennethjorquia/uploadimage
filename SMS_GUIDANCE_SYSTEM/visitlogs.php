    ...
    <li class="breadcrumb-item active" aria-current="page">Data</li>
          ...
          <h2>Visit Logs</h2>
            <div class="d-flex justify-content-between align-items-center">
              ...
              <button class="btn text-black me-3  dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"> Excuse Letter </button>
              <button type="button" class="btn btn-primary  text-light">Enter</button>
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#">Excuse Letter</a></li>
                    <li><a class="dropdown-item" href="#">Clearance</a></li>
                    <li><a class="dropdown-item" href="#">Certificate of Candidacy</a></li>
                </ul>
              </div>   
