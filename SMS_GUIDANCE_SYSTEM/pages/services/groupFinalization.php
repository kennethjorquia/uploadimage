    ...
    <li class="breadcrumb-item active" aria-current="page">Data</li>
      ...
      <form action="../../group.php">
          <div class="p-3" style="background-color:#f0f0f0;">
            <h2 class="text-center">Jorquia Kenneth</h2>
            <h6 class="text-center">19014022</h6>
            <h6 class="text-center">BSIT 4104</h6>
          <div class="d-flex justify-content-between">
            <label> Behavior Therapy</label>
            <label> Date/Time Counseled:</label>
          </div>
        
            <div class="row g-0">
                <label class="col-6 col-xl-6"> Background of the Case:</label>
                <label class="col-6 col-xl-6"> Counseling Goals:</label>
                <textarea class="col-6 col-xl-6" style="height: 200px"></textarea>
                <textarea class="col-6 col-xl-6" style="height: 200px"></textarea>
            </div>
            <div class="row g-0">
                <label class="col-6 col-xl-6"> Comments:</label>
                <label class="col-6 col-xl-6"> Recommendation:</label>
                <textarea class="col-6 col-xl-6" style="height: 200px"></textarea>
                <textarea class="col-6 col-xl-6" style="height: 200px"></textarea>
            </div>
            ...
            <div class="text-center p-2">
              <button type="button p-3" class="btn btn-secondary">Cancel</button>
              <button type="button p-3" class="btn btn-primary">Save</button>
            </div>
        </form>
